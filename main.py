...
#Data paths
sk_path = ('/content/sk/sk')
cs_path = ('/content/cs/cs')
pl_path = 'D:\Files\pl\pl'
be_path = 'D:\Files\be\be'
bg_path = '/content/bg/bg'
hu_path = 'D:\Files\hu\hu'
ru_path = ('/content/ru/ru')
sl_path = ('/content/sl/sl')
uk_path = ('/content/uk/uk')
sr_path = ('/content/sr/sr')
